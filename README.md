...
*Objective:* Provide a library/API that ingests infection and outcome data to provide simulated outcomes based on local isolation/quarantine policy levers.

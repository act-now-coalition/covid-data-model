...
@click.option('--output', '-o', default='results/top_counties', help='Output directory for artifacts')
def deploy(run_validation, input_dir, output):
    """The entry function for invocation"""

    county_result = top_counties_pipeline.run_projections(input_dir, run_validation=True)

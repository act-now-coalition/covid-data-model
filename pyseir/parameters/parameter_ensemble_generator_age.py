...
class ParameterEnsembleGeneratorAge:
    ...
    def generate_age_specific_parameters(self):
        """
        Generate age specific hospitalization_rate_general,
        hospitalization_rate_icu, and mortality_rate_from_ICU.
        """
    ...
    def generate_age_specific_initial_conditions(self):
        """
        Generate initial condition based on age distriubtion.
        """
        contact_matrix_data = load_data.
        return None

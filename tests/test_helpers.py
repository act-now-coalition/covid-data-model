...
def make_tag(
    ...
    elif tag_type is taglib.TagType.KNOWN_ISSUE_DATE_RANGE:
        kwargs["start_date"] = pd.to_datetime(kwargs.get("start_date", "2020-04-02")).date()
        kwargs["end_date"] = pd.to_datetime(kwargs.get("end_date", "2020-04-02")).date()

...
def test_annotation_tag_types():
    ...
    manual_block_tag_types = _get_subclass_tag_types(taglib.ManualOverrideAnnotation)
    assert sorted(annotation_tag_types + manual_block_tag_types) == sorted(
        timeseries.ANNOTATION_TAG_TYPES
    )

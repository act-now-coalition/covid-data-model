...
from libs.datasets.sources import can_scraper_providers
...
def test_state_providers_smoke_test():
    ...
    assert can_scraper_providers.CANScraperStateProviders.make_dataset()
    assert can_scraper_providers.CANScraperStateProviders.make_dataset()
    assert can_scraper_providers.CANScraperStateProviders.make_dataset.cache_info().hits > 0

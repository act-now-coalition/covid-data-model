...
from libs.datasets.sources.cdc_testing_dataset import CDCTestingDataset, CDCHistoricalTestingDataset
...
ALL_TIMESERIES_FEATURE_DEFINITION: FeatureDataSourceMap = {
    ...
    CommonFields.TEST_POSITIVITY_7D: [CDCTestingDataset, CDCHistoricalTestingDataset],

...
def load_us_timeseries_dataset(
    ...
    warnings.warn("START: MultiRegionDataset.read_from_pointer()")
    read = MultiRegionDataset.read_from_pointer(pointer)
    warnings.warn("END: MultiRegionDataset.read_from_pointer()")
    return read

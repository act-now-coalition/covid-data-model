...
ALL_TIMESERIES_FEATURE_DEFINITION: FeatureDataSourceMap = {
    ...
    CommonFields.BEDS_WITH_COVID_PATIENTS_RATIO_HSA: [CDCCommunityLevelsDataset],
    ...
    CommonFields.WEEKLY_NEW_HOSPITAL_ADMISSIONS_COVID_PER_100K_HSA: [CDCCommunityLevelsDataset],
...
def load_us_timeseries_dataset(
    ...
    return MultiRegionDataset.read_from_pointer(pointer, load_demographics=load_demographics)

...
class CovidUtil:
    ...
    def initialize_model_parameters(self, model_params):
        ...
        model_params["case_fatality_rate_hospitals_overwhelmed"] = (
            model_params["hospitalization_rate"]
            * model_params["hospitalized_cases_requiring_icu_care"]
        )
        model_params["rolling_intervals_for_current_infected"] = int(
            round(
                model_params["total_infected_period"] / model_params["model_interval"],
                0,
            )
        )
        return model_params

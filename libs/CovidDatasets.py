...
def create_local_copy_public_data():
    ...
    """
    github_zip_url = (
        "https://github.com/covid-projections/covid-data-public/archive/master.zip"
    )
    public_data_local_url = (
        f"file://localhost{local_public_data}/covid-data-public-master"
    )
    _logger.info(
        f"Creating a Local Copy of {github_zip_url} at {public_data_local_url}"
    )

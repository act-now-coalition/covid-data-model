...
def test_build_timeseries():
    ...
    combined, provenance = _build_dataframe({"cases": ["source_a", "source_b"]}, datasets)
    assert combined.at[("97123", "2020-04-01"), "cases"] == 2
    assert provenance.at[("97123", "2020-04-01"), "cases"] == "source_b"

    combined, provenance = _build_dataframe({"cases": ["source_b", "source_a"]}, datasets)
...
def test_build_timeseries_override():
    ...
    combined, provenance = _build_dataframe(

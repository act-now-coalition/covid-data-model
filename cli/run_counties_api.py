...
@click.option(
    "--summary-output", default="results/output", help="Output directory for county summaries.",
)
def deploy_counties_api(disable_validation, input_dir, output, summary_output):
    ...
    for intervention in list(Intervention):
        ...
        county_summaries, county_timeseries = api_pipeline.generate_api(county_result, input_dir)
